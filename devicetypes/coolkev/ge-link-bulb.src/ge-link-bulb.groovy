...
metadata {
	definition (name: "GE Link Bulb", namespace: "coolkev", author: "coolkev") {
...
def parse(String description) {
	log.trace "parse called: $description"
	...
	//log.trace "zigbee.parse result: $msg"
    ...
    if (description?.startsWith("read attr")) {
    	...
    	if (description[27..28] == "0A") {
			...
			return createEvent( name: "level", value: i )
